...
It allows to delete a blob in a BlobStore container for several providers:
...
* Run the code.
  ...
  * `<BLOB_NAME>`      by name of blob in the container.

  Run application:

  ```bash
  java -jar jcloudsblobstoredeleteobject.jar <CONTAINER_NAME> <BLOB_NAME>
  ```
